...
//           maxEmployees={Math.max(...companies.map(c => c.employees), 100)}
//           sort={sort}
//           setSort={setSort}
//         />
//         {loading ? (
...
//         ) : (
//           <>
//             <Grid container columns={12} columnSpacing={4} rowSpacing={4} sx={{ my: 3 }}>
//               {companies.map(company => (
//                 <Grid key={company.id} gridColumn="span 3">
...
//               ))}
//             </Grid>
//             <PaginationControls page={page} totalPages={totalPages} setPage={setPage} pageSize={6} setPageSize={() => {}} />
//           </>
//         )}
